...
public class YarnInteractable : MonoBehaviour
{
    ...
    public bool interactable = false; // whether this character should be enabled right now
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (!interactable || collision.name != "Player")
            return;
    ...
    [YarnCommand ("setNode")]
    public void SetYarnNode(string name)
    {
        conversationStartNode = name;
    }
